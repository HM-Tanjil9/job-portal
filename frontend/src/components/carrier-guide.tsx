    ...
    <div className=" max-w-7xl mx-auto px-4 py-16 ">
      <div className="text-center mb-12">
        ...
        <p className="text-lg opacity-70 max-w-2xl mx-auto mb-8">
          Get personalized job recommendations, career advice and learning
          roadmap based on your skills
        </p>
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button size={"lg"} className="gap-2 h-12 px-8">
              <Sparkles size={18} /> Get Your Career Guidance
              <ArrowRight size={18} />
            </Button>
          </DialogTrigger>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {skills.map((s) => (
                          ...
                          >
                            ...
                            <button
                              className="h-5 w-5 rounded-full justify-center items-center bg-red-500 text-white flex in-checked:justify-center"
              ...
              <>
                <DialogHeader>
                  <DialogTitle className="text-2xl flex items-center gap-2">
                    ...
                    Your personalized carrier guide
                  </DialogTitle>
                </DialogHeader>
                <div className="space-y-6 py-4">
                  <div className="p-4 rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-b-blue-200 dark:border-b-blue-800">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <h3 className="font-semibold mb-2">Carrier Summery</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
                      ...
                      Skills to enhanced your carrier
                    </h3>
